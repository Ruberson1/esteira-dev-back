 ...
 * ##################
 */
Route::group(['prefix' => 'api/v1', 'namespace' => 'V1\Auth', 'as' => User::class], function () {
    Route::post('/register', [
 ...
 * #####################
 */
Route::group(['prefix' => 'api/v1', 'namespace' => 'V1\Profile', 'as' => Profile::class], function () {
    Route::post('/profile', [
  ...
  * #####################
  */
Route::group(['prefix' => 'api/v1', 'namespace' => 'V1\Status', 'as' => Status::class], function () {
    Route::post('/status', [
 ...
 * #################
 */
Route::group(['prefix' => 'api/v1', 'namespace' => 'V1\Bug', 'as' => Bug::class], function () {
 ...
 * ##################
 */
Route::group(['prefix' => 'api/v1', 'namespace' => 'V1\Task', 'as' => Task::class], function () {
    ...
    Route::get('/tasks', [
        'uses' => 'TaskController@findAll',
        'middleware' => [
            'auth',
            'UnauthorizedMiddleware',
        ]
    ]);
    Route::get('/task/{param}', [
        'uses' => 'TaskController@findBy',
        'middleware' => [
            'auth',
            'UnauthorizedMiddleware',
        ]
    ...
    Route::get('/task/status/{status}', [
        'uses' => 'TaskController@findByStatus',
        'middleware' => [
            'auth',
            'UnauthorizedMiddleware',
        ]
 ...
 * ##################
 */
Route::group(['prefix' => 'api/v1', 'namespace' => 'V1\History', 'as' => History::class], function () {
 ...
 * ##################
 */
Route::group(['prefix' => 'api/v1', 'namespace' => 'V1\BugImage', 'as' => BugImage::class], function () {

    Route::post('/bug/image', [
        'uses' => 'BugImageController@uploadImage'
    ]);
//    Route::get('/bug/image', [
//        'uses' => 'BugImageController@getImage'
//    ]);
 ...
 * #################
 */
Route::group(['prefix' => 'api/v1', 'namespace' => 'V1\User', 'as' => User::class], function () {
 ...
 * #################
 */
Route::group(['prefix' => 'api/v1', 'namespace' => 'V1\Pull', 'as' => Pull::class], function () {
